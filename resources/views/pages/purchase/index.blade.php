...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">Purchase</h4>
        ...
        <div class="card">
            ...
            <div class="card-datatable text-nowrap">
                <table class="table table-bordered datatables-ajax" id="table-purchase">
                    <thead>
                        <tr>
                            <th>No.</th>
                        ...
                        @foreach ($purchases as $purchase)
                            @foreach ($purchase->purchasedetail as $data)
                                <tr>
                                    ...
                                    <td>{{ $data->qty }}</td>
                                    <td>{{ $data->price }}</td>
                                    <td>{{ \Carbon\Carbon::parse($purchase->date)->isoFormat('D MMMM Y') }}</td>
